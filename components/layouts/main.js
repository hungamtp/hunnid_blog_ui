        ...
        <nav className="nav__pc">
          <div className="header-container">
            ...
            <div className="hd-item">
              <Link className="nav-link" href="/cff">
                cff
              </Link>
            </div>
            <div className="hd-item">
        ...
        <div className="footer-py-30 footer-bar">
          <div className="container text-center">
            <div className="row align-items-center">
                ...
                <div className="text-sm-start">
                  ...
                  <div className="social-section">
                    <div className="social-item">
                      <a href="https://www.facebook.com/hungmathip" target="_blank">
                    ...
                    <div className="social-item">
                      <a href="https://www.instagram.com/hungnb_/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
                          <path
                            fill="white"
                    ...
                    <div className="social-item">
                      <a href="https://www.linkedin.com/in/hunguyenb/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
                          <path
                            fill="white"
              ...
              <div className="col-sm-6">
                <div className="text-sm-start">
                  <p className="mb-0">If you want it, you gon' get up earlier than any morning </p>
                  <p>If you want it, you gon' get up earlier than anyone</p>
                </div>
              </div>
            </div>
          </div>
